...
namespace RustAnalyzer.Analyzers
{
    ...
    public sealed class LoadDefaultMessagesAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString Title = "Incorrect LoadDefaultMessages declaration";
        private static readonly LocalizableString MessageFormat = 
            ...
            "    }, this);\n" +
            "}";
        private static readonly LocalizableString Description = "LoadDefaultMessages should be declared as protected override void.";
        ...
        private static void AnalyzeMethodDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            bool isVoid = methodDeclaration.ReturnType is PredefinedTypeSyntax predefinedType && 
