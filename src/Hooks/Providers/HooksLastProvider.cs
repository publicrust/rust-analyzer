...
namespace RustAnalyzer.src.Hooks.Providers
{
  ...
  ""hooks"": [
    ...
    ""IOnPlayerConnected(BasePlayer player)"",
    ""IOnRconInitialize()"",
    ""IOnRunCommandLine()"",
    ...
    ""OnBoomboxToggle(BoomBox boombox, BasePlayer player, bool isPlaying)"",
    ...
    ""OnClothingItemChanged(PlayerInventory inventory, Item item, bool bAdded)"",
    ...
    ""OnCodeChanged(BasePlayer player, CodeLock codeLock, string newCode, bool isGuestCode)"",
    ...
    ""OnDebrisSpawn(DecayEntity entity, Vector3 position, Quaternion rotation, bool dropToTerrain)"",
    ...
    ""OnElevatorButtonPress(ElevatorLift elevator, BasePlayer player, Elevator.Direction direction, bool isEmergency)"",
    ...
    ""OnEntityDistanceCheck(BaseEntity entity, BasePlayer player, uint id, string debugName, float maximumDistance, bool checkParent)"",
    ...
    ""OnGrowableGather(GrowableEntity growable, BasePlayer player, bool eat)"",
    ...
    ""OnNearbyTurretsScan(AutoTurret turret, List<AutoTurret> nearbyTurrets, bool created)"",
    ...
    ""OnPlayerKicked(BasePlayer player, string reason, bool reserveSlot)"",
    ...
    ""OnPlayerTick(BasePlayer player, PlayerTick msg, bool wasPlayerStalled)"",
    ...
    ""OnSamSiteModeToggle(SamSite samSite, BasePlayer player, bool isDefenderMode)"",
    ...
    ""OnSleepingBagValidCheck(SleepingBag sleepingBag, ulong playerId, bool ignoreTimers)"",
    ...
    ""OnStructureDemolish(StabilityEntity structure, BasePlayer player, bool isInstant)"",
    ...
    ""OnWireClear(BasePlayer player, IOEntity entity, int index, IOEntity connectedEntity, bool isInput)"",
    ""OnWireConnect(BasePlayer player, IOEntity inputEntity, int inputIndex, IOEntity outputEntity, int outputIndex, List<Vector3> linePoints, List<float> slackLevels)"",
